...
from new_env.util.serializable import Serializable
from new_env.mujoco.mujoco_env import MujocoEnv
from new_env.util.env_util import quat_to_zangle, zangle_to_quat, quat_create, quat_mul
...
class SawyerMocapBase(MujocoEnv, Serializable, metaclass=abc.ABCMeta):
    ...
    def __init__(self, model_name, frame_skip=1):
